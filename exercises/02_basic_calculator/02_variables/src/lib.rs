...
pub fn speed(start: u32, end: u32, time_elapsed: u32) -> u32 {
    ...
    //  It is not needed to explicitly annotate the type of distance, it will be concluded by the compiler, as distance is end - start and both (end) and (start) are u32 type variables
